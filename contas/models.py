...
#mudar senha de int para varchar no banco
#ver melhor firld para atributo celular
#ver melhor firld para atributo RA
...
class Coordenador(models.Model):
    ...
    def __str__(self):
        return self.nome
#mudar senha de int para varchar no banco
#ver melhor field para atributo celular


class Professor(models.Model):
    idProfessor = models.AutoField(db_column='ID_Professor', primary_key=True)  
    login = models.CharField(unique=True, max_length=15, blank=True, null=True)
    senha = models.CharField(max_length=20)
    nome = models.CharField(max_length=90)
    email = models.CharField(unique=True, max_length=90)
    celular = models.CharField(unique=True, max_length=9, blank=True, null=True)
...
class Mensagem(models.Model):
    ...
    assunto = models.CharField(max_length=90, blank=True, null=True)
    referencia = models.CharField(max_length=90, blank=True, null=True)
    conteudo = models.CharField(max_length=900, blank=True, null=True)
    ...
    resposta = models.CharField(max_length=9000, blank=True, null=True)
